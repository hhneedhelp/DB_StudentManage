...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_addStudent_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_addStudent_t qt_meta_stringdata_addStudent = {
    {
        QT_MOC_LITERAL(0, 10),  // "addStudent"
        QT_MOC_LITERAL(11, 22),  // "on_btn_confirm_clicked"
        QT_MOC_LITERAL(34, 0),  // ""
        QT_MOC_LITERAL(35, 21)   // "on_btn_cancel_clicked"
    },
    "addStudent",
...
Q_CONSTINIT static const uint qt_meta_data_addStudent[] = {
...
Q_CONSTINIT const QMetaObject addStudent::staticMetaObject = { {
    ...
    qt_meta_stringdata_addStudent.offsetsAndSizes,
    qt_meta_data_addStudent,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_addStudent_t,
        // Q_OBJECT / Q_GADGET
